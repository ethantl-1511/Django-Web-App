...
## Introduction
During a two-week internship with Prosper IT Consulting, I participated in the creation of a database-driven Django web application using Python. The internship gave me job experience using the Agile/Scrum methodology and Azure DevOps; I was given a minimum of 4 stories to complete, and an additional 6 to complete over the course of a two week sprint. I completed all 10 with time to spare.
<br><br>
