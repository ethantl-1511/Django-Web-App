...
Below are further descriptions of the various stories I worked on, along with code snippets of the work. The full code for all of my personal project files are also in this repository, along with a <a href="https://github.com/ethantl-1511/Python-Internship/tree/main/images">folder of images</a> to show visual examples of each section. 
